...
#include "FemtoDstAnalyzer_PID_old.C"
...
int main(int argc, char** argv)
{
  ...
  if (argc < 9)
  {
    std::cerr << "./FemtoDstAnalyzer_PID_old -i INPUTFILE -o OUTPUTFILE -m WORKMODE -g ENERGY" << std::endl;
    return 10;
  }
  ...
  FemtoDstAnalyzer_PID_old(inFileName.Data(),outFileName.Data(),WorkMode.Data(),Energy.Data());
