...
#include "FemtoDstAnalyzer_Hadrons.C"
//#include "functions.C"
...
int main(int argc, char** argv)
{
  ...
  if (argc < 9)
  {
    std::cerr << "./FemtoDstAnalyzer_Hadrons -i INPUTFILE -o OUTPUTFILE -m WORKMODE -g ENERGY" << std::endl;
    return 10;
  }
  ...
  FemtoDstAnalyzer_Hadrons(inFileName.Data(),outFileName.Data(),WorkMode.Data(),Energy.Atoi());
